...
public class IpIntervalTest {
    @Test
    public void ipv4() {
        IpInterval<?> subject = IpInterval.parse("128/8");
        assertThat(subject.toString(), is("128.0.0.0/8"));
    }

    @Test
    public void ipv6() {
        IpInterval<?> subject = IpInterval.parse("::0/8");
        assertThat(subject.toString(), is("::/8"));
    }

    @Test
    public void ipInterval_ipv4() throws Exception {
        IpInterval<?> subject = IpInterval.asIpInterval(InetAddress.getByName("128.0.0.0"));
